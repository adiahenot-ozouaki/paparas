  ...
  return (
    <div
      style={{
        ...
        inset: 0,
        background:
          'radial-gradient(ellipse at 50% 20%, rgba(214,168,79,0.12) 0%, rgba(18,60,50,0.2) 40%, #0B0D10 100%)',
        display: 'flex',
      ...
      >
        {STATS.map((s, i) => (
          ...
          >
            ...
            <span className="font-display" style={{ color: '#fff', fontSize: 13, fontWeight: 700, textAlign: 'right' }}>
              {s.value}
            </span>
          </div>
        ))}
