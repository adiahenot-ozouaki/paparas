...
export default function HomeScreen({ onNavigate }: { onNavigate: (s: Screen) => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginTop: 4 }}>
            ...
            <span style={{ color: '#A9B0B7', fontSize: 11 }}>net cumulé (solo)</span>
          </div>
        </div>
        <div
          style={{
      ...
      <div style={{ display: 'flex', gap: 12, padding: '0 20px', marginTop: 8 }}>
        {[
        ...
        {lifetimeStats.gamesPlayed === 0 ? (
          ...
          >
            <p style={{ color: '#A9B0B7', fontSize: 13, margin: 0 }}>
              Aucune partie solo pour l’instant — lancez votre première partie !
            </p>
          </div>
        ) : (
          <div
          ...
          >
            <span style={{ color: '#A9B0B7', fontSize: 13 }}>
              {lifetimeStats.gamesWon} victoire{lifetimeStats.gamesWon > 1 ? 's' : ''} sur {lifetimeStats.gamesPlayed}{' '}
              partie{lifetimeStats.gamesPlayed > 1 ? 's' : ''} (solo)
            </span>
            <span
              style={{
                color: lifetimeStats.netGainTotal >= 0 ? '#4CAF76' : '#C94B4B',
